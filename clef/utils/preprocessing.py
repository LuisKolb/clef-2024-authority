...
def clean_text_basic(text):
    if (text is None) or (text is np.nan):
        ...
        # TODO: does this improve results? hashtags are... whacky (sometimes contain important information); see e.g. rumor AuRED_104
        text = re.sub(r"[\.\,\|\?\?\/\=\#]", " ", text)  # remove special characters; also remves the # but leaves the text of a hashtag
        ...
        text = re.sub(r"\u2019", "", text)  # remove ’ character
        text = re.sub(r'\"', " ", text)     # remove " character
        text = re.sub(r'\s\:', " ", text)     # remove " :" pattern
        ...
        text = re.sub(r"[ \t]+", " ", text)  # remove extra blank space and all tabs
